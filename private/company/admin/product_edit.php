<?php 
  ...
  $gets=mysqli_query($connect,"SELECT * FROM category WHERE id_category=$id_category");
  ...
  if (isset($_POST['edit'])) {
    ...
    $category=$_POST['category'];
      ...
      $sql_update="UPDATE `product` SET `name_product` = '$name', `image_product` = '$gambar', `id_category` = '$category' WHERE `product`.`id_product` = $id";
      if ($sql_update) {
					...
					<div class="row">
						<div class="col-md-6">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="name_product" placeholder="Product Name" value="<?php echo $data['name_product'] ?>">
							</div>
						</div>
            <div class="col-md-6">
              <div class="form-group">
                ...
                <select class="form-control col-md-12" required="" name="category">
                    <option disabled=""><?php echo $set['category']; ?></option>
