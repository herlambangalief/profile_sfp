<?php 
  ...
  if (isset($_POST['edit'])) {
    ...
    $footer=$_POST['footer'];
      ...
      $sql_update="UPDATE `footer` SET `services` = '$footer' WHERE `footer`.`id_footer` = $id";
      if ($sql_update) {
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="footer" placeholder="Services" value="<?php echo $data['services'] ?>">
							</div>
						</div>
