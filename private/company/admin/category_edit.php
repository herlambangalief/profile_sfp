<?php 
  ...
  if (isset($_POST['edit'])) {
    ...
    $category=$_POST['category'];
      ...
      $sql_update="UPDATE `category` SET `category` = '$category' WHERE `category`.`id_category` = $id";
      if ($sql_update) {
					...
					<div class="row">
						<div class="col-md-12">
							<div class="form-group">
								...
								<input type="text" class="form-control" required name="category" placeholder="Category" value="<?php echo $data['category'] ?>">
							</div>
						</div>
